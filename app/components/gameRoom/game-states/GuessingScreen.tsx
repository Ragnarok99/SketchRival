...
export default function GuessingScreen({ isPaused = false }: GuessingScreenProps) {
  ...
  if (isCurrentDrawer) {
    return (
      <div className="flex flex-col lg:flex-row gap-4 p-4 w-full max-w-6xl mx-auto">
        {/* Columna Principal (Vista del Dibujante) */}
        <div className="flex-grow flex flex-col items-center justify-center min-h-[400px] sm:min-h-[500px] bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8">
          {isPaused ? (
        ...
        {/* Columna de Chat (para el dibujante) */}
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 p-2 sm:p-4 w-full max-w-6xl mx-auto">
      {/* Columna Principal (Dibujo y Formulario de Adivinanza) */}
      <div className="flex-grow flex flex-col items-center bg-white rounded-lg shadow-md p-4 sm:p-6">
        {isPaused && (
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center z-10 rounded-lg">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              <h3 className="text-xl font-bold text-gray-800 mb-2">Juego pausado</h3>
